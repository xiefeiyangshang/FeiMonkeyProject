...
import com.whatyplugin.imooc.logic.utils.ConfigUtil;
import com.whatyplugin.imooc.logic.utils.DataSet;
import com.whatyplugin.imooc.logic.utils.DownloadController;
import com.whatyplugin.imooc.logic.utils.ParamsUtil;
import com.whatyplugin.imooc.ui.base.MCBaseActivity;
import com.whatyplugin.imooc.ui.view.PlayChangeVideoPopupWindow;
import com.whatyplugin.imooc.ui.view.PlayTopPopupWindow;
import com.whatyplugin.imooc.ui.view.PopMenu;
import com.whatyplugin.imooc.ui.view.Subtitle;
import com.whatyplugin.imooc.ui.view.VerticalSeekBar;
 ...
 *
 */
public class MCCourseCCVideoMediaPlayActivity extends MCBaseActivity implements
    ...
    private void showMobileDialog() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(MCCourseCCVideoMediaPlayActivity.this);
    ...
    private void initPlayInfo() {
        ...
        vidList = getIntent().getStringArrayListExtra("vidList");
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        ShowMoocCommon.startRecordTimer(id, player.getDuration()+"", MCBaseDefine.MCMediaType.MC_VIDEO_TYPE, this);
        ShowMoocCommon.updateTimeInfo(id, this.courseId, null);
...
//			firstInitDefinition = false;
        ...
        definitionMenu = new PopMenu(this, R.drawable.popdown, currentDefinitionIndex, getResources().getDimensionPixelSize(R.dimen.mooc_60_dp));
        // 设置清晰度列表
    ...
    private int getCurrentVideoIndex() {
        ...
        return vidList.indexOf(videoId) ;
    }
    ...
    private void changeVideo(int position, boolean isCompleted) {
        ...
        videoId = "74DB43E3F9D90ACF9C33DC5901307461";
        ...
        player.reset();
        player.setDefaultDefinition(defaultDefinition);
        player.setVideoPlayInfo(videoId, ConfigUtil.USERID, ConfigUtil.API_KEY, MCCourseCCVideoMediaPlayActivity.this);
...
*/
    ...
    public void onPause() {
        ...
        super.onPause();
        ShowMoocCommon.stopRecordTimer(this.id);// 停止记录
